...
export class FlexComponent implements OnInit {
  ...
  estiloIcono = 'bg-white shadow-lg rounded-lg rounded-circle p-5 mx-auto'
  estiloH3 = 'text-center mt-3 text-white'
...
`
  ...
  ngOnInit(): void {
    ...
    document.getElementById("reloj").innerHTML = `${this.reloj_path}`;
    document.getElementById("calendario").innerHTML = `${this.calendario_path}`;
    document.getElementById("pin").innerHTML = `${this.pin_path}`;
  ...
  hoy = new Date()
  hora = this.hoy.getHours()+ ':' + this.hoy.getMinutes()
  fecha = new Date().toLocaleDateString('es-ES', this.options)
  dia = `${ this.hoy.getDate() } de ${ this.hoy.getMonth() }`
